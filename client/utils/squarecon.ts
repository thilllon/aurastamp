...
// function unsecureRandom(length: number) {
//   let out = '';
//   while (out.length < length) out += Math.random().toString(16).substring(2);
//   return out.substring(0, length);
// }

// function loopHash(hasher: (str: string) => void, str: string, length: number): string {
//   let out = '';
//   let i = 0;
...
// function getMinIdLength(pixels: number, colors: number) {
...
//     let tmp = parseInt(str.substr(i, 1), 16);
//     Array.prototype.push.apply(bits, [
//       (tmp & 8) !== 0,
//       (tmp & 4) !== 0,
//       (tmp & 2) !== 0,
//       (tmp & 1) !== 0,
...
//  * @returns {string}
//  */
// function readcolor(str: string, scheme: string) {
//   if (scheme === 'raw') {
//     return '#' + str;
//   } else {
//     return randomColor({ seed: str, luminosity: scheme, format: 'hex' });
//   }
// }
...
//  * @returns {Array}
//  */
// function filledarray<T>(value: T, length: number) {
//   const out: T[] = [];
