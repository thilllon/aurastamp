...
export const breakpointsValues = { xs: 0, sm: 375, md: 768, lg: 1366, xl: 1920 };
    ...
    components: {
      ...
      MuiContainer: {
        styleOverrides: {
          ...
          //   },
          // },
          [`@media (min-width: ${breakpointsValues.xs}px) and (orientation: landscape)`]: {
            //
          },
        },
      },
