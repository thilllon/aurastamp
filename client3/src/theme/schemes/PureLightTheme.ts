...
import { alpha, BreakpointsOptions, createTheme, darken, lighten } from '@mui/material/styles';
...
// Default values for MUI theme
// https://mui.com/customization/default-theme/

// Mapping table between sxProps(system key) versus css property
...
const themeColors = {
  primary: '#5569ff',
  secondary: '#191919', //secondary: '#6E759F', '#223354'
  success: '#57CA22',
  warning: '#FFA319',
  error: '#FF1943',
  info: '#33C2FF',
...
export const PureLightTheme = createTheme({
  ...
  typography: {
    fontFamily:
      '"Inter", "Noto Sans KR", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
    h1: {
      fontWeight: 700,
      fontSize: 35,
    },
    ...
    subtitle2: {
      fontWeight: 400,
      fontSize: 15,
      color: colors.alpha.black[70], // #223354
    },
    overline: {
      fontSize: 13,
      fontWeight: 700,
