...
function Highlights() {
  ...
  return (
    <BoxHighlights>
      <BoxLayouts>
        <BoxWave>
          <svg viewBox='0 0 1440 172' fill='none' xmlns='https://www.w3.org/2000/svg'>
            <path
        ...
        <BoxLayoutsContent maxWidth='lg'>
          <Grid justifyContent='center' alignItems='center' spacing={6} container>
            ...
            <Grid item xs={12} md={6}>
              <LayoutImgButton target='_blank' rel='noopener' href='/dashboards/reports'>
            ...
            <Grid item xs={12} md={6}>
              ...
              <List disablePadding sx={{ mt: 2 }}>
                <ListItem>
                  ...
                  <ListItemText
                    primary={t('96+ Google Lighthouse performance score across all app pages.')}
                  />
                </ListItem>
                <ListItem>
                  <AvatarSuccess sx={{ mr: 2 }}>
          ...
          <>
            ...
            <Grid container sx={{ textAlign: 'center' }} spacing={4}>
              <Grid item xs={12} md={4}>
                ...
                <Typography variant='subtitle2'>
                  {t('Firebase, AWS Amplify, JWT Tokens and Auth0 are available in this release')}
                </Typography>
              </Grid>
              <Grid item xs={12} md={4}>
                <AvatarSuccess sx={{ mx: 'auto', width: 50, height: 50 }}>
