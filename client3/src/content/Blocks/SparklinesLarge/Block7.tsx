          ...
          >
            ...
            >
              <Grid container spacing={4}>
                <Grid item xs={12}>
                  <CardBorderBottom sx={{ borderBottomColor: `${theme.colors.success.main}` }}>
                    <Box p={3}>
                      <Typography
                        gutterBottom
                        variant='h1'
                ...
                <Grid item xs={12}>
                  <CardBorderBottom sx={{ borderBottomColor: `${theme.colors.error.main}` }}>
                    ...
                    <Chart options={Box2Options} series={Box2Data} type='area' height={100} />
                  </CardBorderBottom>
                </Grid>
              </Grid>
            </BoxComposedContent>
        ...
        <Grid item xs={12} lg={7} sx={{ display: 'flex', flexDirection: 'column' }}>
          <Box p={3}>
            <Box>
              ...
              <Typography variant='subtitle2' sx={{ fontSize: `${theme.typography.pxToRem(15)}` }}>
          ...
          <Box flexGrow={1} px={2} pb={2}>
            <Chart options={chart3Options} series={chart3Data} type='line' height={'100%'} />
          </Box>
          <Divider />
          <Box
            p={3}
