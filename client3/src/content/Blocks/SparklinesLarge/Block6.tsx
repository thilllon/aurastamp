...
function Block6() {
  ...
  return (
    <Card sx={{ background: `${theme.colors.gradients.blue1}` }}>
      <Box p={3} display='flex' alignItems='center' justifyContent='space-between'>
        <Box>
          ...
          <Typography variant='subtitle2' sx={{ color: `${theme.colors.alpha.trueWhite[70]}` }}>
      ...
      <Box p={3} sx={{ background: `${theme.colors.alpha.black[5]}` }}>
        <Chart options={Box1Options} series={Box1Data} type='line' height={94} />
      </Box>
      <Divider sx={{ background: `${theme.colors.alpha.trueWhite[10]}` }} />
      <Box py={2}>
        <Stack
        ...
        >
          <Box p={3} flexGrow={1}>
            <Typography variant='h3' sx={{ color: `${theme.colors.alpha.trueWhite[100]}` }}>
              76%
            </Typography>
            <LinearProgress1 sx={{ my: 1 }} variant='determinate' value={76} />
            <Typography
              gutterBottom
              variant='subtitle2'
          ...
          <Box p={3} flexGrow={1}>
            <Typography sx={{ color: `${theme.colors.success.main}` }} variant='h3'>
              43%
            </Typography>
            <LinearProgress2 sx={{ my: 1 }} variant='determinate' value={43} />
            <Typography
              gutterBottom
              variant='subtitle2'
              sx={{ color: `${theme.colors.alpha.trueWhite[70]}` }}
          ...
          <Box p={3} flexGrow={1}>
            ...
            <LinearProgress3 sx={{ my: 1 }} variant='determinate' value={59} />
            <Typography
              gutterBottom
              variant='subtitle2'
              sx={{ color: `${theme.colors.alpha.trueWhite[70]}` }}
