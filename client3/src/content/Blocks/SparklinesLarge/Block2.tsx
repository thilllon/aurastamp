...
function Block2() {
  ...
  return (
    <Card>
      <Box p={3}>
        <Stack direction='row' justifyContent='space-evenly' alignItems='stretch' spacing={0}>
      ...
      >
        <Button variant='contained' color='success' endIcon={<ArrowForwardTwoToneIcon />}>
          {t('View recent sales')}
        </Button>
      </Box>
      <Divider />
      <Box p={3}>
        <Chart options={Box1Options} series={Box1Data} type='line' height={86} />
      </Box>
    </Card>
  );
}
