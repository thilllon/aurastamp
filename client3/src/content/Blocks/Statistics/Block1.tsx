    ...
    <Grid container spacing={4}>
      <Grid item xs={12} sm={6} md={3}>
        <Card
          sx={{
            ...
            boxShadow: `
                    ...
                    0 0.25rem 0.54rem ${alpha(theme.colors.success.main, 0.06)}, 
        ...
        >
          ...
          <Box pt={1.5} display='flex' alignItems='center' justifyContent='space-between'>
            <Typography variant='h2' sx={{ color: `${theme.colors.success.main}` }}>
              <CountUp
                start={0}
                end={4.658}
                duration={6}
            ...
            <Typography variant='h5' sx={{ color: `${theme.colors.success.main}` }}>
              +35.2%
            </Typography>
          </Box>
        </Card>
        ...
        <Card
          sx={{
            ...
            boxShadow: `
                    ...
                    0 0.25rem 0.54rem ${alpha(theme.colors.warning.main, 0.06)}, 
                    0 0.13rem 0.19rem ${alpha(theme.colors.warning.main, 0.04)}`,
          }}
        >
          <Typography variant='subtitle2'>{t('Expenses')}</Typography>
          <Box pt={1.5} display='flex' alignItems='center' justifyContent='space-between'>
            <Typography variant='h2' sx={{ color: `${theme.colors.warning.main}` }}>
              <CountUp
                start={0}
                end={18.564}
                duration={6}
            ...
            <Typography variant='h5' sx={{ color: `${theme.colors.warning.main}` }}>
              +3.25%
            </Typography>
          </Box>
        </Card>
      ...
      <Grid item xs={12} sm={6} md={3}>
        ...
        >
          ...
          <Box pt={1.5} display='flex' alignItems='center' justifyContent='space-between'>
            <Typography variant='h2' sx={{ color: `${theme.colors.info.main}` }}>
              <CountUp
                start={0}
                end={56.484}
                duration={6}
            ...
            <Typography variant='h5' sx={{ color: `${theme.colors.info.main}` }}>
              +75.25%
            </Typography>
          </Box>
        </Card>
      ...
      <Grid item xs={12} sm={6} md={3}>
        ...
        >
          ...
          <Box pt={1.5} display='flex' alignItems='center' justifyContent='space-between'>
            <Typography variant='h2' sx={{ color: `${theme.colors.error.main}` }}>
              <CountUp
                start={0}
                end={5849}
                duration={6}
            ...
            <Typography variant='h5' sx={{ color: `${theme.colors.error.main}` }}>
              +65.35%
            </Typography>
          </Box>
        </Card>
