...
function Block7() {
  ...
  return (
    <Grid container spacing={4}>
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ background: `${theme.colors.gradients.blue4}` }}>
          <CardActionAreaWrapper
            sx={{
              p: 3,
              display: 'flex',
          ...
          >
            <Box display='flex'>
              ...
              <Box ml={2}>
                ...
                <Typography sx={{ color: `${theme.colors.alpha.trueWhite[100]}` }} variant='h2'>
                  $68,483
                </Typography>
                <Box ml={-0.5} mt={1.5} display='flex' alignItems='center'>
                  <Typography
            ...
            <ChevronRightTwoToneIcon sx={{ color: `${theme.colors.alpha.trueWhite[100]}` }} />
          </CardActionAreaWrapper>
        </Card>
      </Grid>
      <Grid item xs={12} md={4}>
