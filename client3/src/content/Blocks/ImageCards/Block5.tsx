...
import { AccessTimeTwoTone as AccessTimeTwoToneIcon } from '@mui/icons-material';
  ...
  return (
    <Grid container spacing={4}>
      <Grid item xs={12} lg={6}>
        ...
        >
          <BgComposed sx={{ p: { xs: 3, md: 5, lg: 10 } }}>
            <Link
              href='#'
              underline='none'
              lineHeight={1.5}
            ...
            <Divider sx={{ my: 3, background: `${theme.colors.alpha.trueWhite[10]}` }} />
            <Avatar
      ...
      <Grid item xs={12} lg={6}>
        ...
        >
          <BgComposed sx={{ p: { xs: 3, md: 5, lg: 8 } }}>
