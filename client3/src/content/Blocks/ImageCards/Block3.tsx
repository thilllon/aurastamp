          ...
          <Box sx={{ position: 'relative', p: 3 }}>
            <Box display='flex' alignItems='center' justifyContent='space-between'>
              <Box display='flex' alignItems='center'>
                <Avatar sx={{ width: 44, height: 44 }} src='/static/images/avatars/3.jpg' />
              ...
              <Typography variant='subtitle1' sx={{ display: 'flex', alignItems: 'center' }}>
                <AccessTimeTwoToneIcon fontSize='small' sx={{ opacity: 0.7, mr: 0.5 }} />
                {format(subDays(new Date(), 5), 'MMMM dd yyyy')}
              </Typography>
            </Box>
            <Typography variant='h3' color='text.secondary' fontWeight='normal' sx={{ py: 2 }}>
              {t(
        ...
        <Card sx={{ p: 3 }}>
          ...
          <Box sx={{ textAlign: 'center', position: 'relative' }}>
            <Box display='flex' alignItems='center' flexDirection='column' justifyContent='center'>
              <Avatar sx={{ width: 74, height: 74, mb: 1 }} src='/static/images/avatars/5.jpg' />
