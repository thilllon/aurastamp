      ...
      <Grid item xs={12} md={6} lg={3}>
        <Card sx={{ px: 3, pt: 2, pb: 1 }}>
          <Box mb={2} display='flex' alignItems='center' justifyContent='space-between'>
            <Typography variant='subtitle2' sx={{ fontSize: `${theme.typography.pxToRem(16)}` }}>
              {t('Customers')}
            </Typography>
          ...
          <Box display='flex' alignItems='center' justifyContent='space-between'>
            <Box sx={{ width: '120px' }}>
              ...
              >
                <Typography variant='h3' sx={{ color: `${theme.colors.info.main}`, mt: '-20px' }}>
                  {`${data.percentage1}%`}
                </Typography>
              </CircularProgressbarWithChildren>
            </Box>
          ...
          <Box display='flex' mb={2} alignItems='center' justifyContent='space-between'>
            <Box sx={{ width: '102px' }}>
              ...
              >
                <Typography
                  variant='h3'
                  sx={{ color: `${theme.colors.primary.main}`, mt: '-20px' }}
                >
                  {`${data.percentage2}%`}
                </Typography>
              </CircularProgressbarWithChildren>
        ...
        <Card sx={{ position: 'relative', p: 3 }}>
          ...
          <Box display='flex' flexDirection='column' alignItems='center' justifyContent='center'>
            <Box sx={{ width: '105px' }}>
              ...
              >
                <Typography variant='h3' sx={{ color: `${theme.colors.error.main}`, mt: '-20px' }}>
                  {`${data.percentage3}%`}
                </Typography>
              </CircularProgressbarWithChildren>
            </Box>
          ...
          <Box display='flex' flexDirection='column' alignItems='center' justifyContent='center'>
            <Box sx={{ width: '105px' }}>
              ...
              >
                <Typography
                  variant='h3'
                  sx={{ color: `${theme.colors.success.main}`, mt: '-20px' }}
                >
                  {`${data.percentage3}%`}
                </Typography>
              </CircularProgressbarWithChildren>
