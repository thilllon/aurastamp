    ...
    <Grid container spacing={4}>
      <Grid item xs={12} md={4}>
        <CardWrapper sx={{ p: 2 }}>
          <Box display='flex' alignItems='center' justifyContent='space-between'>
            <Typography sx={{ fontSize: `${theme.typography.pxToRem(18)}` }} variant='h3'>
              {t('Weekly Sales')}
            </Typography>
          ...
          <Box sx={{ mx: 'auto', my: 2, maxWidth: '210px' }}>
            ...
            >
              <Typography sx={{ color: `${theme.colors.primary.main}`, mt: -1.7 }} variant='h2'>
                {`${data.percentage1}%`}
              </Typography>
            </CircularProgressbarWithChildren>
          </Box>
      ...
      <Grid item xs={12} md={4}>
        <CardWrapper sx={{ p: 2 }}>
          ...
          <Box sx={{ mx: 'auto', mt: 2, maxWidth: '230px' }}>
            <CircularProgressbarWithChildren
              circleRatio={0.75}
              styles={buildStyles({
            ...
            >
              <LabelError sx={{ mt: -1.5 }}>
                <ArrowUpwardTwoToneIcon sx={{ mr: 0.5 }} />
                <span>1,65k</span>
              </LabelError>
              <Typography sx={{ mt: 0.5 }} variant='h4' color='text.secondary' fontWeight='normal'>
                {t('last week')}
              </Typography>
            </CircularProgressbarWithChildren>
          </Box>
      ...
      <Grid item xs={12} md={4}>
        <CardWrapper sx={{ p: 2, background: `${theme.colors.gradients.black2}` }}>
          <Box display='flex' alignItems='center' justifyContent='space-between'>
            <Typography
              sx={{
          ...
          <Box sx={{ mx: 'auto', my: 2, maxWidth: '210px' }}>
            ...
            >
              <Typography
                sx={{ color: `${theme.colors.alpha.trueWhite[100]}`, mt: -1.7 }}
                variant='h2'
              >
                {`${data.percentage3}%`}
              </Typography>
