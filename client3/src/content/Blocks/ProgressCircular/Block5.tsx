  ...
  return (
    <Card>
      <Box py={2} px={3}>
        ...
        <Typography variant='subtitle2'>{t('Earnings split based on customers')}</Typography>
      </Box>
            ...
            {items.map((item) => (
              <Fragment key={item.id}>
                ...
                <ListItem sx={{ py: 2, px: 2.5 }}>
                  <ListItemAvatar sx={{ display: 'flex', alignItems: 'center', mr: 1.5 }}>
                    <Box display='inline-flex' position='relative'>
                      ...
                      <CircularProgress
                        variant='determinate'
                        sx={{ color: (theme) => theme.colors.alpha.black[10] }}
                        size={56}
                        thickness={2}
                        value={100}
                      />
