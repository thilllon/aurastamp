    ...
    <Grid container spacing={4}>
      <Grid item xs={12} md={4}>
        <Card sx={{ position: 'relative' }}>
          <Typography
            sx={{ py: 3, fontSize: `${theme.typography.pxToRem(18)}` }}
            variant='h4'
            textAlign='center'
          >
            {t('Storage Status')}
          ...
          <Box sx={{ mx: 'auto', maxWidth: '170px' }}>
            ...
            >
              <Typography color='primary' sx={{ mt: -2 }} variant='h1'>
                {`${data.percentage1}%`}
              </Typography>
            </CircularProgressbarWithChildren>
          </Box>
          <Box my={2} display='flex' alignItems='center' justifyContent='center'>
            <Box mx={0.5} display='flex' justifyContent='center' alignItems='center'>
              <DotLegend style={{ background: `${theme.colors.primary.main}` }} />
              <Typography
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ position: 'relative' }}>
          ...
          <Box sx={{ mx: 'auto', maxWidth: '163px' }}>
            ...
            >
              <LabelError sx={{ mt: '-20px' }}>765</LabelError>
            </CircularProgressbarWithChildren>
          </Box>
          <Box my={2}>
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ position: 'relative' }}>
          ...
          <Box sx={{ mx: 'auto', maxWidth: '132px' }}>
            ...
            >
              <Typography color='warning' sx={{ mt: '-15px' }} variant='h2'>
                {data.percentage3}
              </Typography>
            </CircularProgressbarWithChildren>
          </Box>
          <Box sx={{ mx: { xs: 3, md: 10 } }}>
            <Grid container spacing={2} mt={1} mb={2}>
              <Grid item xs={12} sm={6}>
                <Box display='flex' alignItems='center'>
                  <DotLegend style={{ background: `${theme.colors.success.main}` }} />
                  <Typography sx={{ lineHeight: 1 }} variant='body1' color='text.secondary'>
                    {t('successful')}
                  </Typography>
                </Box>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <Box display='flex' alignItems='center'>
                  <DotLegend style={{ background: `${theme.colors.info.main}` }} />
                  <Typography sx={{ lineHeight: 1 }} variant='body1' color='text.secondary'>
                    {t('reported')}
                  </Typography>
                </Box>
