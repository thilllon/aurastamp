...
function Block7() {
  ...
  return (
    ...
    >
      <BoxComposed sx={{ background: `${theme.colors.gradients.blue1}` }}>
        <CardActions>
          <LabelSuccess>{t('New')}</LabelSuccess>
        </CardActions>
        <BoxComposedBg sx={{ opacity: 0.1, background: `${theme.colors.gradients.blue3}` }} />
        <BoxComposedImage
          sx={{
            opacity: 0.3,
        ...
        />
        <BoxComposedContent sx={{ textAlign: 'center' }} py={6}>
          <Typography sx={{ px: { xs: 4, md: 12 }, pb: 1.5, lineHeight: 1.5 }} variant='h2'>
            {t('The Ultimate UI Design System at your fingertips!')}
          </Typography>
          <Typography
            sx={{ mb: 2.5, px: { xs: 4, md: 8 }, lineHeight: 1.6 }}
            fontWeight='normal'
            variant='h4'
          >
            {t(
                ...
                <TableCell>
                  <Box display='flex' alignItems='center'>
                    ...
                    <Box ml={1.5}>
                      ...
                      <Typography variant='subtitle2'>Senior Project Manager</Typography>
                    </Box>
                  </Box>
                </TableCell>
                <TableCell align='center'>
