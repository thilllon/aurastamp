...
function Block13() {
  ...
  return (
    ...
    >
      ...
      />
      <Typography sx={{ color: `${theme.colors.alpha.trueWhite[100]}` }} gutterBottom variant='h2'>
        Ricardo Cologne
      </Typography>
      ...
      <Box display='flex' justifyContent='center'>
        <Tooltip arrow placement='top' title={t('View details')}>
          <IconButton
            ...
            size='large'
          >
            <VisibilityTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(20)}` }} />
          </IconButton>
        </Tooltip>
        <Tooltip arrow placement='top' title={t('Add to favourites')}>
          ...
          >
            <FavoriteTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(20)}` }} />
          </IconButton>
        </Tooltip>
        <Tooltip arrow placement='top' title={t('View user profile')}>
          <IconButton
            ...
            size='large'
          >
            <PersonSearchTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(20)}` }} />
          </IconButton>
        </Tooltip>
      </Box>
    </Card>
