    ...
    <Card sx={{ position: 'relative', p: 3 }}>
      ...
      <Box mb={2} display='flex' alignItems='center'>
        ...
        <Box sx={{ width: '100%' }} ml={1.5}>
          ...
          <Box display='flex' alignItems='center' flex={1} sx={{ width: '100%' }}>
            <LinearProgressPrimary
              sx={{ minWidth: 65, width: '100%' }}
              variant='determinate'
              value={39}
            />
            <Typography sx={{ pl: 1 }} fontWeight='bold' variant='body1' textAlign='right'>
              +39%
            </Typography>
          </Box>
        </Box>
      ...
      <List disablePadding sx={{ my: 1.5 }}>
        <ListItem disableGutters>
          <ListItemText primaryTypographyProps={{ variant: 'h5' }} primary={t('Email') + ':'} />
        ...
        <ListItem disableGutters>
          <ListItemText primaryTypographyProps={{ variant: 'h5' }} primary={t('Location') + ':'} />
