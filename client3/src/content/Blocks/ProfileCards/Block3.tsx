...
const BgComposed = styled(Box)(
  ({ theme }) => `
    ...
    z-index: 6;
    opacity: 0;
    box-shadow: inset 0 0 2.3rem 0.5rem ${darken(theme.colors.primary.main, 0.9)};
  `
);
...
function Block3() {
  ...
  return (
    <Card sx={{ pt: 2, overflow: 'visible', textAlign: 'center' }}>
      <Box
        sx={{
          mx: 2,
          position: 'relative',
      ...
      >
        ...
        <CardMedia
          component='img'
          height='222'
          sx={{ borderRadius: 'inherit', position: 'relative', zIndex: 5 }}
          image='/static/images/placeholders/covers/1.jpg'
          alt='...'
        />
        <CardActions sx={{ bottom: 'auto', top: `${theme.spacing(2)}` }}>
          <Label
            sx={{
      ...
      <Box p={4}>
        ...
        <Typography sx={{ px: 3 }} variant='subtitle2' textAlign='center'>
          {t(
