  ...
  return (
    <Grid container spacing={4}>
      <Grid item xs={12} md={4}>
        <CardBorderBottom sx={{ borderBottomColor: `${theme.colors.primary.main}` }}>
          <Box p={2}>
            <Link
              href='#'
              color='text.primary'
          ...
          >
            <Box display='flex' alignItems='center'>
              ...
              <Typography
                sx={{ display: 'flex', mr: 1.5, alignItems: 'center' }}
                variant='subtitle1'
              >
                <LinkTwoToneIcon sx={{ mr: 0.4 }} fontSize='small' />
                55
              </Typography>
              <Typography
                sx={{ display: 'flex', mr: 1.5, alignItems: 'center' }}
                variant='subtitle1'
              >
                <VisibilityTwoToneIcon sx={{ mr: 0.4 }} fontSize='small' />
                458
              </Typography>
            </Box>
            <Typography sx={{ display: 'flex', alignItems: 'center' }} variant='subtitle1'>
              <ScheduleTwoToneIcon sx={{ mr: 0.4 }} fontSize='small' />
              {t('Today')} - 9:45 am
            </Typography>
          </Box>
        </CardBorderBottom>
      ...
      <Grid item xs={12} md={4}>
        ...
        >
          <Box p={2}>
            ...
            <AvatarGroup sx={{ mt: 1.5, justifyContent: 'center' }}>
              <Avatar
      ...
      <Grid item xs={12} md={4}>
        <CardBorderBottom sx={{ borderBottomColor: `${theme.colors.error.main}` }}>
          <Box p={2}>
            <Link
              href='#'
              color='text.primary'
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ background: `${theme.colors.gradients.blue3}` }} variant='outlined'>
          <Box p={2}>
            <Link
              href='#'
              sx={{
          ...
          <Box
            ...
            justifyContent='space-between'
            p={2}
            sx={{ background: `${theme.colors.alpha.trueWhite[5]}` }}
          >
            <Box display='flex' alignItems='center'>
              <IconButtonWrapper
                size='small'
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ background: `${theme.colors.gradients.black1}` }} variant='outlined'>
          <Box p={2}>
            <Link
              href='#'
              sx={{
