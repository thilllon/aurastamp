  ...
  return (
    <Grid container spacing={4}>
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5 }} variant='outlined'>
          <Box display='flex' alignItems='center' justifyContent='space-between'>
            <Box display='flex' alignItems='center'>
              ...
              <Box ml={1.5}>
                ...
                <Typography variant='subtitle2'>UI Engineer, Apple Inc.</Typography>
              </Box>
            </Box>
            <Box display='flex' alignItems='center'>
              <Avatar
              ...
              >
                <CheckTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(16)}` }} />
              </Avatar>
              <Typography
                variant='body1'
                sx={{
          ...
          <Box display='flex' justifyContent='center' py={2}>
            <Tooltip arrow placement='top' title={t('View details')}>
              <IconButton color='primary'>
                <VisibilityTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(18)}` }} />
              </IconButton>
            </Tooltip>
            <Tooltip arrow placement='top' title={t('Add to favourites')}>
              <IconButton sx={{ mx: 1 }} color='primary'>
                <FavoriteTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(18)}` }} />
              </IconButton>
            </Tooltip>
            <Tooltip arrow placement='top' title={t('View user profile')}>
              <IconButton color='primary'>
                <PersonSearchTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(18)}` }} />
              </IconButton>
            </Tooltip>
          </Box>
          <Divider />
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5 }} variant='outlined'>
          <Box display='flex' alignItems='center' justifyContent='space-between'>
            <Box display='flex' alignItems='center'>
              ...
              <Box ml={1.5}>
                ...
                <Typography variant='subtitle2'>Senior Consultant, Google</Typography>
              </Box>
            </Box>
            <Box display='flex' alignItems='center'>
              <Avatar
              ...
              >
                <HourglassTopTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(16)}` }} />
              </Avatar>
              <Typography
                variant='body1'
                sx={{
          ...
          <Box display='flex' justifyContent='center' py={2}>
            ...
            <Tooltip arrow placement='top' title={t('Add to favourites')}>
              <IconButton sx={{ mx: 1 }} color='success'>
                <FavoriteTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(18)}` }} />
              </IconButton>
            </Tooltip>
            <Tooltip arrow placement='top' title={t('View user profile')}>
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5 }} variant='outlined'>
          <Box display='flex' alignItems='center' justifyContent='space-between'>
            <Box display='flex' alignItems='center'>
              ...
              <Box ml={1.5}>
                ...
                <Typography variant='subtitle2'>Lead UX Designer, Spotify</Typography>
              </Box>
            </Box>
            <Box display='flex' alignItems='center'>
              <Avatar
              ...
              >
                <CloseTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(16)}` }} />
              </Avatar>
              <Typography
                variant='body1'
                sx={{
          ...
          <Box display='flex' justifyContent='center' py={2}>
            ...
            <IconButton disabled sx={{ mx: 1 }} color='error'>
              <FavoriteTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(18)}` }} />
            </IconButton>
            <IconButton disabled color='error'>
              <PersonSearchTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(18)}` }} />
          ...
          <Divider />
          <Stack
            sx={{ mt: 2.5, opacity: 0.7, textAlign: 'center' }}
            direction='row'
            justifyContent='space-evenly'
            alignItems='center'
            spacing={2}
