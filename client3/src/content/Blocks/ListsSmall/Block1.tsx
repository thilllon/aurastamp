...
function Block1() {
  ...
  return (
    <Card variant='outlined' sx={{ background: `${alpha(theme.colors.alpha.black[100], 0.03)}` }}>
      <CardHeader
        sx={{ p: 3 }}
        disableTypography
        action={
      ...
      />
      <CardContentWrapper sx={{ mx: 3, mb: 3, height: 344 }}>
        <Scrollbar>
                ...
                secondary={
                  <>
                    <Box mt={0.7} display='flex' alignItems='center'>
                      ...
                      >
                        {t('opened')}
                        {formatDistance(subMinutes(new Date(), 43), new Date(), {
                          addSuffix: true,
                        })}
                      </Typography>
                    </Box>
                ...
                secondary={
                  <>
                    <Box mt={0.7} display='flex' alignItems='center'>
                      ...
                      >
                        {t('opened')}
                        {formatDistance(subMinutes(new Date(), 76), new Date(), {
                          addSuffix: true,
                        })}
                      </Typography>
                    </Box>
                ...
                secondary={
                  <>
                    <Box mt={0.7} display='flex' alignItems='center'>
                      ...
                      >
                        {t('opened')}
                        {formatDistance(subMinutes(new Date(), 90), new Date(), {
                          addSuffix: true,
                        })}
                      </Typography>
                    </Box>
                ...
                secondary={
                  <>
                    <Box mt={0.7} display='flex' alignItems='center'>
                      ...
                      >
                        {t('opened')}
                        {formatDistance(subMinutes(new Date(), 47), new Date(), {
                          addSuffix: true,
                        })}
                      </Typography>
                    </Box>
