    ...
    <Card>
      <Box p={2.5} display='flex' alignItems='center' justifyContent='space-between'>
        <Box>
          ...
          <Typography variant='subtitle2'>{t('Status of your crypto assets')}</Typography>
        </Box>
        <Box>
      ...
      <Divider />
      <Box px={2} py={4} sx={{ textAlign: 'center' }}>
        <Typography
          fontWeight='bold'
          sx={{ lineHeight: 1, fontSize: `${theme.typography.pxToRem(40)}` }}
        >
          <Typography
            variant='caption'
