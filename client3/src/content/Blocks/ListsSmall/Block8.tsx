    ...
    <Card>
      <Box p={2.5} display='flex' alignItems='center' justifyContent='space-between'>
        <Box>
          ...
          <Typography variant='subtitle2'>{t('Your recent crypto activities')}</Typography>
        </Box>
        <ToggleButtonGroup size='small' value={tabs} exclusive onChange={handleViewOrientation}>
          <ToggleButton
            sx={{
              px: 2,
              py: 0.5,
              ...
              <Timeline>
                <TimelineItem sx={{ p: 0 }}>
                  ...
                  <TimelineContent sx={{ pb: 4 }}>
                    ...
                    <Typography sx={{ pt: 1 }} variant='body2' color='text.primary'>
      ...
      {!tabs && (
        <Box
          ...
          sx={{ height: 422, textAlign: 'center' }}
        >
          <Box>
            <Typography
              align='center'
            ...
            <Button sx={{ mt: 4 }}>Maybe, a button?</Button>
          </Box>
        </Box>
      )}
    </Card>
