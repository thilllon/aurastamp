...
function Block6() {
  ...
  return (
    <Card variant='outlined'>
      <CardHeader
        sx={{ p: 2, background: `${theme.colors.alpha.black[5]}` }}
        disableTypography
        title={
      ...
      <Divider />
      <List disablePadding>
        <ListItemWrapper sx={{ alignItems: 'flex-start', p: 3.15 }}>
          <Box className='MuiActionButtons'>
            <Tooltip arrow placement='top' title={t('Purchase a single license')}>
            ...
            secondary={
              <>
                <Typography
                  ...
                  variant='subtitle2'
                >
                  <PersonOutlineTwoToneIcon sx={{ mr: 0.5 }} fontSize='small' />
                  <b>3487</b>
