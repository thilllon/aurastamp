  ...
  return (
    <Card>
      <CardHeader
        ...
        disableTypography
        action={
          <Button endIcon={<KeyboardArrowDownTwoToneIcon />} variant='outlined' size='small'>
            {t('Actions')}
          </Button>
        }
        title={
      ...
      />
      <BoxComposed sx={{ background: `${theme.colors.gradients.pink2}` }}>
        <BoxComposedBg sx={{ opacity: 0.1, background: `${theme.colors.gradients.black2}` }} />
        <BoxComposedImage
          sx={{
            opacity: 0.1,
        ...
        <BoxComposedContent py={4}>
          <Typography textAlign='center' sx={{ pb: 1 }} variant='h3'>
            {t('Notifications')}
          </Typography>
          ...
          <Box sx={{ height: 300 }}>
            <Scrollbar>
              <Box
                ...
                sx={{ textAlign: 'center' }}
              >
                <ButtonGroup sx={{ mt: 1, mb: 2 }} size='small' variant='outlined'>
                ...
                <Box sx={{ width: '100%' }}>
                  <Chart options={chart1Options} series={chart1Data} type='bar' height={180} />
                </Box>
              </Box>
            </Scrollbar>
          </Box>
