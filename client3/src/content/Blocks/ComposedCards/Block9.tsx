      ...
      <Grid container spacing={0}>
          ...
          >
            ...
            <BoxComposedContent px={8} pt={8} pb={4}>
              <Box display='flex' alignItems='center'>
                ...
                <Tooltip arrow title={t('This is a helper placeholder')} placement='right'>
        ...
        <Grid item xs={12} xl={7}>
                ...
                <Grid container spacing={4}>
                  <Grid item xs={12} sm={4}>
                    <Card variant='outlined' sx={{ p: 2 }}>
                      <Typography variant='h1' sx={{ fontSize: `${theme.typography.pxToRem(40)}` }}>
                        31
                      </Typography>
                      <DividerPrimary sx={{ my: 2 }} />
                      <Typography
                        variant='caption'
                        fontWeight='bold'
          ...
          {currentTab === 'signin' && (
            <>
              <Box p={4}>
                <CardWrapper sx={{ p: 3, textAlign: 'center' }}>
                  ...
                  <Tooltip arrow title={t('Sign in with Amplify')}>
                    <ButtonWrapper sx={{ mx: 1.5 }} size='large' variant='outlined'>
                      <img
                        style={{ height: 28 }}
                        alt='Amplify'
              ...
              <Box p={4}>
                <Grid container spacing={4}>
                  <Grid item xs={12} md={6}>
                    <Card
                      sx={{ overflow: 'visible', position: 'relative', p: 2 }}
                      variant='outlined'
                    >
                      ...
                      <Box mt={1.5} display='flex' alignItems='center'>
                        ...
                        <Text flex color='error'>
                          <AccessTimeTwoToneIcon sx={{ ml: 1, mr: 0.5 }} fontSize='small' />
                          2:35 pm
                        </Text>
                      </Box>
                    </Card>
                ...
                <Timeline sx={{ p: 0, mx: 1, mt: 4, mb: 0 }}>
                  <TimelineItem sx={{ p: 0 }}>
                  ...
                  <TimelineItem sx={{ p: 0 }}>
                    <TimelineSeparator sx={{ position: 'relative' }}>
                      <TimelineDot
                        sx={{ marginTop: 0, top: theme.spacing(1.2) }}
                        variant='outlined'
                        color='error'
                      />
                      <TimelineConnector />
