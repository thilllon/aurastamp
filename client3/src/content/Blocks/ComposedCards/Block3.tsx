...
function Block3() {
  ...
  return (
    <Card>
      ...
      />
      <Divider />
      <CardContent sx={{ py: 0, pl: 1 }}>
        <Chart options={Box3Options} series={Box3Data} type='area' height={273} />
      </CardContent>
      <CardWrapper sx={{ p: 3, textAlign: 'center' }}>
        <ToggleButtonGroup value={tabs} exclusive onChange={handleViewOrientation}>
          <ToggleButton
            sx={{ textTransform: 'none', py: 0.6, px: 1.8 }}
            disableRipple
      ...
      <CardContent sx={{ p: 3 }}>
        <Grid container spacing={6}>
          <Grid item xs={12} sm={6}>
            ...
            <LinearProgressError sx={{ my: 1 }} variant='determinate' value={34} />
            <Box display='flex' alignItems='center' justifyContent='space-between'>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <LinearProgressSuccess sx={{ my: 1 }} variant='determinate' value={78} />
            <Box display='flex' alignItems='center' justifyContent='space-between'>
              <Typography variant='body2' color='text.secondary'>
                {t('Target')}
              </Typography>
