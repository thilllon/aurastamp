...
function Block1() {
  ...
  return (
    <Card>
      <BoxComposed sx={{ background: `${theme.colors.gradients.purple3}` }}>
        <CardActions>
          <Label>{t('New')}</Label>
        </CardActions>
        <BoxComposedBg sx={{ opacity: 0.1, background: `${theme.colors.gradients.black1}` }} />
        <BoxComposedImage
          sx={{
            opacity: 0.1,
      ...
      <Box p={3}>
        <Grid container spacing={6}>
          <Grid item xs={12} sm={4}>
            <CardWrapper elevation={0} sx={{ textAlign: 'center', pt: 3, pb: 2.5 }}>
              <Text color='warning'>
          ...
          <TableBody>
            <TableRow hover>
              ...
              <TableCell align='right'>
                ...
                >
                  <Typography sx={{ pr: 0.5 }} component='span' variant='h4' color='text.primary'>
                    $68,492
                  </Typography>
                  <ArrowUpwardTwoToneIcon sx={{ opacity: 0.6 }} />
                </Typography>
              </TableCell>
            </TableRow>
            <TableRow hover>
              ...
              <TableCell align='right'>
                ...
                >
                  ...
                  <ArrowUpwardTwoToneIcon sx={{ opacity: 0.7 }} />
                </Typography>
              </TableCell>
            </TableRow>
            <TableRow hover>
              ...
              <TableCell align='right'>
                ...
                >
                  ...
                  <ArrowDownwardTwoToneIcon sx={{ opacity: 0.6 }} />
                </Typography>
              </TableCell>
            </TableRow>
          </TableBody>
