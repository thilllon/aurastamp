  ...
  return (
    <Card variant='outlined'>
      <CardWrapper sx={{ p: 2 }}>
        <Box display='flex' alignItems='center' justifyContent='space-between'>
          ...
          >
            <Typography
              fontWeight='normal'
              sx={{ pr: 1, fontSize: `${theme.typography.pxToRem(16)}` }}
              variant='h3'
              component='span'
      ...
      <Box p={3} sx={{ textAlign: 'center' }}>
        ...
        <Box display='flex' mt={2} mb={1} alignItems='center' justifyContent='space-between'>
      ...
      <Box p={3}>
        <Grid container spacing={6}>
          <Grid item xs={12} sm={6}>
            ...
            <LinearProgressError sx={{ my: 1 }} variant='determinate' value={45} />
          ...
          <Grid item xs={12} sm={6}>
            ...
            <LinearProgressSuccess sx={{ my: 1 }} variant='determinate' value={87} />
            <Typography variant='body2' color='text.secondary'>
              {t('Participants')}
            </Typography>
          </Grid>
