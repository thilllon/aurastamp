...
function Block6() {
  ...
  return (
    <Card>
      ...
      <CardWrapper elevation={0} sx={{ textAlign: 'center', p: 3, mx: 5, my: 4 }}>
      ...
      <Box px={5} py={1} display='flex' alignItems='center'>
        ...
        <Box>
          <Typography variant='h4' sx={{ color: `${theme.colors.error.main}` }}>
            $2,835
          </Typography>
        </Box>
      </Box>
      <Box px={5} py={1} display='flex' alignItems='center'>
        ...
        <Box>
          <Typography variant='h4' sx={{ color: `${theme.colors.success.main}` }}>
            $5,542
          </Typography>
        </Box>
      </Box>
      <Box px={5} py={1} display='flex' alignItems='center'>
        ...
        <Box>
          <Typography variant='h4' sx={{ color: `${theme.colors.info.main}` }}>
            $1,375
          </Typography>
        </Box>
      </Box>
