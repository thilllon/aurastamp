      ...
      <Grid item xs={12} md={4}>
        <BoxAbsoluteOverlay>
          ...
          >
            ...
            <Typography variant='h1' sx={{ py: 2, fontSize: `${theme.typography.pxToRem(40)}` }}>
              86.453
            </Typography>
            <Typography
              variant='subtitle2'
          ...
          <ChartOverlay>
            <Chart options={Box1Options} series={Box1Data} type='area' height={200} />
          </ChartOverlay>
        </BoxAbsoluteOverlay>
      </Grid>
      <Grid item xs={12} md={4}>
        <BoxAbsoluteOverlay>
          ...
          <ChartOverlay>
            <Chart options={Box2Options} series={Box2Data} type='bar' height={200} />
          </ChartOverlay>
        </BoxAbsoluteOverlay>
      </Grid>
      <Grid item xs={12} md={4}>
        <BoxAbsoluteOverlay>
          ...
          <ChartOverlay>
            <Chart options={Box3Options} series={Box3Data} type='area' height={200} />
          </ChartOverlay>
        </BoxAbsoluteOverlay>
      </Grid>
    </Grid>
