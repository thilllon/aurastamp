    ...
    <Grid container spacing={3}>
        ...
        <Card>
          <Box display='flex' alignItems='center' p={2}>
            <Badge
              ...
              overlap='circular'
              badgeContent={<DotLegend style={{ background: `${theme.colors.error.main}` }} />}
            >
              <AvatarWrapper alt='Spotify' src='/static/images/placeholders/logo/spotify.svg' />
            </Badge>
            <Box pl={1}>
          ...
          <Divider />
          <Box p={3}>
            <Chart options={Box1Options} series={Box1Data} type='line' height={80} />
          </Box>
          <Divider />
      ...
      <Grid item xs={12} md={4}>
        <Card>
          ...
          <Divider />
          <Box p={3}>
            <Chart options={Box2Options} series={Box2Data} type='line' height={80} />
          </Box>
          <Divider />
          <Box p={2} display='flex' alignItems='center' justifyContent='space-between'>
            <Button variant='outlined' size='small' color='error'>
      ...
      <Grid item xs={12} md={4}>
        <Card>
          <Box display='flex' alignItems='center' p={2}>
            <AvatarWrapper alt='Slack' src='/static/images/placeholders/logo/slack.svg' />
            <Box pl={1}>
              <Typography variant='h4' noWrap>
                Slack
              </Typography>
          ...
          <Divider />
          <Box p={3}>
            <Chart options={Box3Options} series={Box3Data} type='line' height={80} />
          </Box>
          <Divider />
          <Box p={2} display='flex' alignItems='center' justifyContent='space-between'>
            <Button variant='outlined' size='small' color='error'>
