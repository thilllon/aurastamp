      ...
      <Grid item xs={12} md={4}>
        <Card>
          ...
          >
            ...
            <Typography noWrap variant='h3' sx={{ pt: 3 }}>
              {t('Recent Visitors')}
            </Typography>
            <Typography
              noWrap
            ...
            <Divider sx={{ width: '60%', alignSelf: 'center', mt: 3 }} flexItem />
            <Box p={2} display='flex' alignItems='center' justifyContent='space-evenly'>
              ...
              <Tooltip title={t('Add to favourites')}>
                <IconButton sx={{ mx: 1 }} color='secondary'>
