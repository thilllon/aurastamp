import { ScreenSearchDesktopTwoTone as ScreenSearchDesktopTwoToneIcon } from '@mui/icons-material';
...
function Block8() {
  ...
  return (
    <Card>
      <Box display='flex' alignItems='center' p={3} justifyContent='space-between'>
        <Box>
          <Typography
            component='div'
          ...
          <Typography component='div' fontWeight='normal' color='text.secondary' variant='h5'>
            {t('Last 7 days sales statistics report')}
          </Typography>
        </Box>
        <Button size='small' variant='outlined' startIcon={<ScreenSearchDesktopTwoToneIcon />}>
          {t('Advanced search')}
        </Button>
      </Box>
      <CardWrapper sx={{ mx: 3, p: 3 }}>
        <Stack
          direction='row'
          divider={
            <Divider
              sx={{ background: `${theme.colors.alpha.black[10]}` }}
        ...
        >
          <Box py={2} textAlign='center'>
            <Typography variant='h4' fontWeight='normal' color='text.secondary' gutterBottom>
              {t("Today's Earnings")}
            </Typography>
