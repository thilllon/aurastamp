      ...
      <Box p={3}>
        <Grid container spacing={6}>
          <Grid item xs={12} md={5} sx={{ display: 'flex', alignItems: 'center' }}>
            <List sx={{ width: '100%' }} disablePadding>
              <ListItem disableGutters sx={{ display: 'block' }}>
                <Box pb={0.5}>
                  <Typography component='span' variant='h3' sx={{ pr: 1 }}>
                    54,695
                  </Typography>
              ...
              <ListItem disableGutters sx={{ display: 'block' }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <Box sx={{ minWidth: 35 }}>
                    <Typography variant='h5' sx={{ color: `${theme.colors.primary.main}` }}>
                      65%
                    </Typography>
                  </Box>
                </Box>
          ...
          <Grid item xs={12} md={7}>
            <CardWrapper sx={{ p: 3 }}>
              <Box sx={{ height: 267 }}>
                <Block7ChartWrapper data={visitors} labels={generic.month.labels} />
              </Box>
            </CardWrapper>
          </Grid>
        </Grid>
