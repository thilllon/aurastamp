  ...
  return (
    <Card>
      ...
      <Typography
        ...
        textAlign='center'
        fontWeight='bold'
        sx={{ py: 4, fontSize: `${theme.typography.pxToRem(40)}` }}
      >
        <CountUp
          start={0}
          end={458.695}
      ...
      >
        <Box>
          <Typography component='h6' variant='subtitle2' textAlign='center' gutterBottom>
            {t('Current month')}
          </Typography>
          <Typography
            component='h6'
      ...
      <Typography
        component='div'
        sx={{ mt: 3, fontSize: `${theme.typography.pxToRem(17)}` }}
        textAlign='center'
        variant='h3'
      >
        {t('Monthly report')}
      ...
      <CardContent>
        <Chart options={chart1Options} series={chart1Data} type='bar' height={302} />
      </CardContent>
    </Card>
  );
}
