  ...
  return (
    <Card>
      <CardHeader
        sx={{ p: 3 }}
        action={
          <Button size='small' variant='outlined' endIcon={<ExpandMoreTwoToneIcon />}>
            {t('Actions')}
          </Button>
        }
        title={t('Users list')}
      ...
      <Divider />
      <CardContent sx={{ p: 4 }}>
        <Box sx={{ mb: 4, height: 343 }}>
          <Block4ChartWrapper data={visitors} labels={generic.year.labels} />
        </Box>
        <Grid container spacing={4}>
          <Grid item xs={12} sm={6}>
            <Typography component='div' color='text.primary' variant='h4' sx={{ pb: 1 }}>
              {t('Orders')}
            </Typography>
            <LinearProgressPrimary variant='determinate' value={35.76} />
            <Box display='flex' sx={{ mt: 0.5 }} alignItems='center' justifyContent='space-between'>
