  ...
  return (
    <Card>
      ...
      <CardContent sx={{ pt: 0 }}>
        ...
        >
          <Box py={3} sx={{ width: '100%' }}>
            <Typography
              ...
              fontWeight='bold'
              textAlign='center'
              sx={{ color: `${theme.colors.alpha.black[100]}`, pb: 1 }}
            >
              {t('Income')}
            </Typography>
            <DividerInfo />
        ...
        <Typography component='h6' variant='subtitle2' fontWeight='bold' textAlign='center'>
        ...
        >
          <Box sx={{ width: '100%' }}>
            <Typography
              ...
              variant='h2'
              textAlign='center'
              sx={{ color: `${theme.colors.info.main}`, pb: 1 }}
            >
              32.5%
            </Typography>
          </Box>
          <Box sx={{ width: '100%' }}>
            <Typography
              ...
              variant='h2'
              textAlign='center'
              sx={{ color: `${theme.colors.success.main}`, pb: 1 }}
            >
              67.5%
            </Typography>
          </Box>
