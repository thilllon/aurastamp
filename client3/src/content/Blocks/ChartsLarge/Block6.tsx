...
function Block6() {
  ...
  const status = {
    month: {
      current: [22, 40, 37, 14, 34, 13, 31, 30, 15, 29, 25, 39, 21, 26, 19, 16, 20],
    },
  };
  ...
  return (
    <CardWrapper>
      <Box sx={{ pt: 3, px: 2, mb: 5, height: 267 }}>
      ...
      >
        <Box>
          <Typography
            ...
            fontWeight='bold'
            textAlign='center'
            sx={{ pb: 2, color: `${theme.colors.alpha.trueWhite[70]}` }}
          >
            {t('Returning Users')}
          </Typography>
          <Gauge
            ...
            <CardWhite>
              <Box mb={3} display='flex' alignItems='flex-start' justifyContent='space-between'>
                <Box display='flex' alignItems='center'>
                  ...
                  >
                    <AvatarWrapper alt='Leonardo Delgado' src='/static/images/avatars/3.jpg' />
                  </Badge>
                  <Box sx={{ ml: 1 }}>
                    <Typography variant='caption' gutterBottom fontWeight='bold' noWrap>
                      {t('Customer')}
                    </Typography>
            ...
            <CardWhite>
              <Box mb={3} display='flex' alignItems='flex-start' justifyContent='space-between'>
                <Box display='flex' alignItems='center'>
                  ...
                  >
                    <AvatarWrapper alt='Brynn Kayghton' src='/static/images/avatars/5.jpg' />
                  </Badge>
                  <Box sx={{ ml: 1 }}>
                    <Typography variant='caption' gutterBottom fontWeight='bold' noWrap>
                      {t('Client')}
