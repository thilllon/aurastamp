...
const LinearProgressWhite = styled(LinearProgress)(
  ({ theme }) => `
        ...
        &.${linearProgressClasses.colorPrimary} {
            ...
            box-shadow: inset 0 1px 2px ${alpha(theme.colors.alpha.trueWhite[100], 0.2)};
        }
    ...
    <Grid container spacing={4}>
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 3 }}>
          ...
          <LinearProgressWrapper sx={{ my: 3 }} variant='determinate' value={67.5} />
          <Box display='flex' alignItems='flex-start' justifyContent='space-between'>
            <ButtonWrapper
              sx={{
            ...
            <Typography sx={{ color: `${theme.colors.info.main}` }} variant='subtitle2'>
              {t('In progress')}
            </Typography>
          </Box>
        </Card>
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 3 }}>
          ...
          <LinearProgressError sx={{ my: 3 }} variant='determinate' value={67.5} />
          <Box display='flex' alignItems='flex-start' justifyContent='space-between'>
            <ButtonWrapper
              sx={{
                background: `${theme.colors.error.main}`,
            ...
            <Typography sx={{ color: `${theme.colors.error.main}` }} variant='subtitle2'>
              {t('Overdue')}
            </Typography>
          </Box>
        </Card>
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ background: `${theme.colors.gradients.blue2}`, p: 3 }}>
          <Box display='flex' alignItems='flex-start' justifyContent='space-between'>
          ...
          <Typography
            sx={{ color: `${theme.colors.alpha.trueWhite[100]}`, mt: 3, mb: 2 }}
            variant='h3'
          >
            {t('The Ultimate UI Design System at your fingertips!')}
          </Typography>
          <Typography sx={{ color: `${theme.colors.alpha.trueWhite[70]}` }} variant='subtitle2'>
            {t(
              'High performance React template built with lots of powerful components across multiple product niches for fast & perfect apps development processes'
            )}
            .
          </Typography>
          <LinearProgressWhite sx={{ my: 3 }} variant='determinate' value={34.5} />
          <Box display='flex' alignItems='flex-start' justifyContent='space-between'>
            <ButtonWrapper
              sx={{
