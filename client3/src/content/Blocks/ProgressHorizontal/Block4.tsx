    ...
    <Grid container spacing={4}>
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5, flexGrow: 1 }}>
          ...
          <Box display='flex' sx={{ mb: 0.6 }} alignItems='center' justifyContent='space-between'>
            <Typography variant='h5' fontWeight='normal'>
              {t('Remaining')}
            </Typography>
            <Typography sx={{ color: `${theme.colors.primary.main}` }} variant='h4'>
              55%
            </Typography>
          </Box>
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5, flexGrow: 1 }}>
          ...
          <Box display='flex' sx={{ mb: 0.6 }} alignItems='center' justifyContent='space-between'>
            ...
            <Typography sx={{ color: `${theme.colors.success.main}` }} variant='h4'>
              35%
            </Typography>
          </Box>
      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5, flexGrow: 1 }}>
          ...
          <Box display='flex' sx={{ mb: 0.6 }} alignItems='center' justifyContent='space-between'>
            ...
            <Typography sx={{ color: `${theme.colors.error.main}` }} variant='h4'>
              75%
            </Typography>
          </Box>
