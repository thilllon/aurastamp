      ...
      <Grid item xs={12} md={4}>
        <Card sx={{ p: 2.5, flexGrow: 1 }}>
          <Box mb={2} display='flex' alignItems='center' justifyContent='space-between'>
            ...
            <Typography variant='h2' sx={{ color: `${theme.colors.alpha.black[100]}` }}>
              23,594
            </Typography>
          </Box>
          <LinearProgressBlack variant='determinate' value={66.43} />
          <Box display='flex' sx={{ mt: 0.6 }} alignItems='center' justifyContent='space-between'>
            <Typography sx={{ color: `${theme.colors.alpha.black[50]}` }} variant='subtitle2'>
              {t('Target')}
            </Typography>
            <Typography sx={{ color: `${theme.colors.alpha.black[50]}` }} variant='subtitle2'>
              100%
