...
const LinearProgress1 = styled(LinearProgress)(
  ({ theme }) => `
        ...
        &.${linearProgressClasses.colorPrimary} {
            ...
            box-shadow: inset 0 1px 2px ${alpha(theme.colors.alpha.trueWhite[100], 0.08)};
        }
...
function Block9() {
  ...
  return (
    <Card sx={{ background: `${theme.colors.gradients.black2}` }}>
      <Stack
        sx={{ textAlign: 'center' }}
        direction='row'
      ...
      >
        ...
        <Box p={3} flexGrow={1}>
          <Typography sx={{ color: `${theme.colors.warning.main}` }} variant='h3'>
            43%
          </Typography>
