  ...
  return (
    <Grid container spacing={4}>
      <Grid item xs={12} md={6} lg={3}>
        <Card sx={{ pt: 2.5, pb: 2, px: 2.5, flexGrow: 1 }}>
          <Box display='flex' alignItems='center' flex={1} mb={1} sx={{ width: '100%' }}>
            <Typography sx={{ color: `${theme.colors.primary.main}`, pr: 1.5 }} variant='h3'>
              54%
            </Typography>
            <Box flex={1}>
      ...
      <Grid item xs={12} md={6} lg={3}>
        <Card sx={{ pt: 2.5, pb: 2, px: 2.5, flexGrow: 1 }}>
          <Box display='flex' alignItems='center' flex={1} mb={1} sx={{ width: '100%' }}>
            <Typography sx={{ color: `${theme.colors.success.main}`, pr: 1.5 }} variant='h3'>
              68%
            </Typography>
            <Box flex={1}>
      ...
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          <Box display='flex' alignItems='center' flex={1} mb={1} sx={{ width: '100%' }}>
            <Typography sx={{ color: `${theme.colors.error.main}`, pr: 1.5 }} variant='h3'>
              32%
            </Typography>
            <Box flex={1}>
      ...
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          <Box display='flex' alignItems='center' flex={1} mb={1} sx={{ width: '100%' }}>
            <Typography sx={{ color: `${theme.colors.info.main}`, pr: 1.5 }} variant='h3'>
              71%
            </Typography>
            <Box flex={1}>
