...
import { AssessmentTwoTone as AssessmentTwoToneIcon } from '@mui/icons-material';
import {
  Avatar,
  Box,
  Button,
...
const LinearProgressInfo = styled(LinearProgress)(
  ({ theme }) => `
        ...
        &.${linearProgressClasses.colorPrimary} {
            ...
            box-shadow: inset 0 1px 2px ${alpha(theme.colors.alpha.black[100], 0.15)};
        }
      ...
      <Box sx={{ height: 316 }}>
        <Scrollbar>
          <ListWrapper disablePadding>
            <ListItem sx={{ display: { xs: 'block', md: 'flex' }, py: 1, px: 2 }}>
