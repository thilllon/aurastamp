    ...
    <Grid container spacing={4}>
      <Grid item xs={12} md={4}>
        <Card sx={{ position: 'relative', p: 5 }}>
          ...
          <Typography variant='h3' sx={{ mb: 1, fontSize: `${theme.typography.pxToRem(18)}` }}>
            {t('Sales statistics')}
          </Typography>
          <Typography variant='subtitle2' sx={{ mb: 3, fontSize: theme.typography.pxToRem(14) }}>
