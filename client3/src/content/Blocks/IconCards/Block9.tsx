  ...
  return (
    <Grid container spacing={4}>
      <Grid item xs={12} md={4}>
        <Card sx={{ position: 'relative', pl: 3, pr: 2.5, pt: 5, pb: 3 }}>
          <CardActions>
            <Tooltip arrow placement='top' title={t('Add to favourites')}>
              <IconButton sx={{ mr: 0.5 }} size='small' color='secondary'>
                <FavoriteTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(16)}` }} />
              </IconButton>
            </Tooltip>
            <Tooltip arrow placement='top' title={t('Users search')}>
              <IconButton size='small' color='secondary'>
                <PersonSearchTwoToneIcon sx={{ fontSize: `${theme.typography.pxToRem(16)}` }} />
              </IconButton>
            </Tooltip>
          </CardActions>
        ...
        <Card sx={{ position: 'relative', pl: 3, pr: 2.5, pt: 5, pb: 3 }}>
          ...
          <Box mb={2} display='flex' justifyContent='space-between' alignItems='center'>
            ...
            <Box display='flex' alignItems='center'>
              ...
              <Typography variant='body1' sx={{ color: `${theme.colors.error.main}` }}>
                {t('Target failed')}
              </Typography>
            </Box>
          </Box>
