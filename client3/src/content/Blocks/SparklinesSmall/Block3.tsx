      ...
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          ...
          <Box ml={2} flexGrow={1} pt={3}>
            <Chart options={chart1Options} series={chart1Data} type='bar' height={'55%'} />
          </Box>
        </Card>
      </Grid>
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          ...
          <Box ml={2} flexGrow={1} pt={3}>
            <Chart options={chart2Options} series={chart2Data} type='area' height={'55%'} />
          </Box>
        </Card>
      </Grid>
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          ...
          <Box ml={2} flexGrow={1} pt={3}>
            <Chart options={chart3Options} series={chart3Data} type='bar' height={'55%'} />
          </Box>
        </Card>
      </Grid>
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          ...
          <Box ml={2} flexGrow={1} pt={3}>
            <Chart options={chart4Options} series={chart4Data} type='area' height={'55%'} />
          </Box>
        </Card>
      </Grid>
    </Grid>
