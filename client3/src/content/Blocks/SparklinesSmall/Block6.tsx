      ...
      <Grid item xs={12} md={4}>
        <Card>
          ...
          <Box p={2}>
            ...
            <Typography variant='subtitle2'>{t('Successful deployments')}</Typography>
          </Box>
          <Box>
      ...
      <Grid item xs={12} md={4}>
        <Card>
          ...
          <Box p={2}>
            ...
            <Typography variant='subtitle2'>{t('Returning clients reports')}</Typography>
          </Box>
          <Box>
            <Chart options={Box2Options} series={Box2Data} type='area' height={150} />
          </Box>
        </Card>
      </Grid>
      <Grid item xs={12} md={4}>
        <Card>
          ...
          <Box p={2}>
            ...
            <Typography variant='subtitle2'>{t('Pending services integrations')}</Typography>
          </Box>
          <Box>
            <Chart options={Box3Options} series={Box3Data} type='area' height={150} />
          </Box>
        </Card>
      </Grid>
    </Grid>
