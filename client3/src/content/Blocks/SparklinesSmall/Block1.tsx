      ...
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          <Box display='flex' alignItems='flex-start' justifyContent='space-between'>
            <Typography sx={{ color: `${theme.colors.warning.main}` }}>
              <AccessAlarmTwoToneIcon fontSize='large' />
            </Typography>
            <Label color='info'>{t('New')}</Label>
          </Box>
          <Box mt={2}>
            <Typography component='span' sx={{ lineHeight: 1, pr: 0.6 }} variant='h3'>
              2,356
            </Typography>
          ...
          <Box>
            <Chart options={chart1Options} series={chart1Data} type='line' height={90} />
          </Box>
        </CardBorderBottom>
      </Grid>
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          <Box display='flex' alignItems='flex-start' justifyContent='space-between'>
            <Typography sx={{ color: `${theme.colors.error.main}` }}>
          ...
          <Box>
            <Chart options={chart2Options} series={chart2Data} type='line' height={90} />
          </Box>
        </CardBorderBottom>
      </Grid>
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          ...
          <Box>
            <Chart options={chart3Options} series={chart3Data} type='line' height={90} />
          </Box>
        </CardBorderTop>
      </Grid>
      <Grid item xs={12} md={6} lg={3}>
        ...
        >
          <Box display='flex' alignItems='flex-start' justifyContent='space-between'>
            <Typography sx={{ color: `${theme.colors.info.main}` }}>
          ...
          <Box>
            <Chart options={chart4Options} series={chart4Data} type='line' height={90} />
          </Box>
        </CardBorderTop>
      </Grid>
    </Grid>
