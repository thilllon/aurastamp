    ...
    >
      ...
      <Box p={3} display='flex' alignItems='center'>
        ...
        <Box ml={2.5}>
          ...
          <Typography
            sx={{ mb: 1, color: `${theme.colors.alpha.trueWhite[70]}` }}
            variant='subtitle2'
          >
      ...
      <MenuList disablePadding>
        <MenuItemWrapper sx={{ p: 2.5, borderRadius: 0 }} divider>
          <ListItemAvatar sx={{ mr: 1.5, display: 'flex', alignItems: 'center', minWidth: 0 }}>
            <Avatar
              variant='rounded'
              sx={{
                background: `${theme.colors.info.main}`,
          ...
          <ListItemText
            ...
            secondary={
              <Typography sx={{ color: `${theme.colors.alpha.trueWhite[70]}` }}>
                15.4% {t('increase')}
              </Typography>
            }
          />
          <ChevronRightTwoToneIcon
            sx={{ color: `${theme.colors.alpha.trueWhite[30]}`, opacity: 0.8 }}
          />
        </MenuItemWrapper>
        <MenuItemWrapper sx={{ p: 2.5, borderRadius: 0 }} divider>
          <ListItemAvatar sx={{ mr: 1.5, display: 'flex', alignItems: 'center', minWidth: 0 }}>
