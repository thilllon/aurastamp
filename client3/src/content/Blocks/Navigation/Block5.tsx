import { ChevronRightTwoTone as ChevronRightTwoToneIcon } from '@mui/icons-material';
import {
  Avatar,
  Box,
  Card,
          ...
          <Box display='flex' justifyContent='center' alignItems='center' flexGrow={1}>
            <Box>
              <Box sx={{ textAlign: 'center' }} py={5} px={2}>
                ...
                <Typography sx={{ pt: 1 }} variant='subtitle2' textAlign='center'>
                  {t(
              ...
              <MenuListWrapperRounded disablePadding sx={{ mb: 3, mx: 3 }}>
                <MenuItem selected>
                  <ListItemText
        ...
        <Card>
          <Box display='flex' justifyContent='center' alignItems='center' flexGrow={1}>
            <Box>
              ...
              <MenuListWrapperLine disablePadding sx={{ mb: 3, mr: 3 }}>
                <MenuItem selected>
                  <ListItemText
                    primaryTypographyProps={{ variant: 'h5' }}
                    primary={t('Analytics')}
        ...
        <Card>
          <Box display='flex' justifyContent='center' alignItems='center' flexGrow={1}>
            <Box>
              ...
              <MenuListWrapperSquare disablePadding sx={{ mb: 3, mx: 3 }}>
                <MenuItem selected>
                  <ListItemText
                    primaryTypographyProps={{ variant: 'h5' }}
                    primary={t('Analytics')}
