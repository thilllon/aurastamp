...
function Block6() {
  ...
  return (
    <Card>
          ...
          <ListWrapper disablePadding>
            {items.map((item) => (
              <Fragment key={item.id}>
                <ListItem sx={{ display: { xs: 'block', md: 'flex' }, py: 1.5, px: 2 }}>
      ...
      <Divider />
      <CardWrapper elevation={0} sx={{ textAlign: 'right', p: 2 }}>
        <Typography variant='caption' fontWeight='bold'>
          {t('Total')}
          <Typography sx={{ pl: 1 }} component='span' variant='h4' color='text.primary'>
            <b>$12,685</b>
          </Typography>
        </Typography>
      </CardWrapper>
