...
import { MoreVertTwoTone as MoreVertTwoToneIcon } from '@mui/icons-material';
import {
  Avatar,
  Box,
  Card,
...
function Block9() {
  ...
  return (
    <Card sx={{ overflow: 'visible' }}>
      ...
      <List disablePadding>
        <Divider />
        <ListItemButtonWrapper sx={{ display: { xs: 'block', sm: 'flex' }, py: 2, px: 2.5 }}>
          <ListItemAvatar sx={{ minWidth: 'auto', mr: 2, mb: { xs: 2, sm: 0 } }}>
            <Tooltip arrow placement='top' title={t('Task assigned to') + ' Gary Albright'}>
              <Avatar
                sx={{
          ...
          <ListItemText
            ...
            secondary={
              <>
                <LinearProgressSuccess sx={{ mt: 1, mb: 0.5 }} variant='determinate' value={73} />
        ...
        <ListItemButtonWrapper sx={{ display: { xs: 'block', sm: 'flex' }, py: 2, px: 2.5 }}>
          <ListItemAvatar sx={{ minWidth: 'auto', mr: 2, mb: { xs: 2, sm: 0 } }}>
            <Tooltip arrow placement='top' title={t('Task assigned to') + ' Therry Hefaistos'}>
              <Avatar
                sx={{
                  fontSize: `${theme.typography.pxToRem(15)}`,
          ...
          <ListItemText
            ...
            secondary={
              <>
                <LinearProgressSuccess sx={{ mt: 1, mb: 0.5 }} variant='determinate' value={29} />
                <Box display='flex' alignItems='center' justifyContent='space-between'>
                  <Typography
                    sx={{ fontSize: `${theme.typography.pxToRem(12)}` }}
                    variant='subtitle2'
        ...
        <ListItemButtonWrapper sx={{ display: { xs: 'block', sm: 'flex' }, py: 2, px: 2.5 }}>
          <ListItemAvatar sx={{ minWidth: 'auto', mr: 2, mb: { xs: 2, sm: 0 } }}>
            <Tooltip arrow placement='top' title={t('Task assigned to') + ' EA Department'}>
              <Avatar
                sx={{
                  fontSize: `${theme.typography.pxToRem(15)}`,
          ...
          <ListItemText
            ...
            secondary={
              <>
                <LinearProgressError sx={{ mt: 1, mb: 0.5 }} variant='determinate' value={87} />
                <Box display='flex' alignItems='center' justifyContent='space-between'>
                  <Typography
                    sx={{ fontSize: `${theme.typography.pxToRem(12)}` }}
                    variant='subtitle2'
        ...
        <ListItemButtonWrapper sx={{ display: { xs: 'block', sm: 'flex' }, py: 2, px: 2.5 }}>
          <ListItemAvatar sx={{ minWidth: 'auto', mr: 2, mb: { xs: 2, sm: 0 } }}>
            <Tooltip arrow placement='top' title={t('Task assigned to') + ' Herocle Patrocle'}>
              <Avatar
                sx={{
                  fontSize: `${theme.typography.pxToRem(15)}`,
          ...
          <ListItemText
            ...
            secondary={
              <>
                <LinearProgressWarning sx={{ mt: 1, mb: 0.5 }} variant='determinate' value={54} />
                <Box display='flex' alignItems='center' justifyContent='space-between'>
                  <Typography
                    sx={{ fontSize: `${theme.typography.pxToRem(12)}` }}
                    variant='subtitle2'
