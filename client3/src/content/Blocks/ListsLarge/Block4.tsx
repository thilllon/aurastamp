...
function Block4() {
  ...
  return (
    <Card>
      ...
      >
        ...
        >
          <Box>
            ...
            <Typography variant='subtitle2'>{t('Monthly sales reports')}</Typography>
          </Box>
          <Text color='error'>
        ...
        >
          <Box>
            ...
            <Typography variant='subtitle2'>{t('Last month targets')}</Typography>
          </Box>
          <Text color='warning'>
      ...
      >
        ...
        >
          <Box>
            ...
            <Typography variant='subtitle2'>{t('Visitors last week')}</Typography>
          </Box>
          <Text color='success'>
      ...
      >
        ...
        >
          <Box>
            ...
            <Typography variant='subtitle2'>{t('Total average weekly report')}</Typography>
          </Box>
          <Text color='primary'>
        ...
        >
          <Box>
            ...
            <Typography variant='subtitle2'>{t('Total products ordered')}</Typography>
          </Box>
          <Text color='info'>
      ...
      <CardWrapper elevation={0} sx={{ mt: 3, mx: 3, mb: 4, p: 2, textAlign: 'center' }}>
        <Button
          size='small'
          color='primary'
          variant='contained'
