...
function ResourcesAlarm() {
  ...
  const chartData = [
    {
      ...
      data: [32, 32, 32, 18, 18, 18, 24, 14, 24, 28, 28, 28, 31, 31, 31, 21, 21, 21, 15, 15, 15],
    },
    {
      name: 'Current Period',
      data: [22, 40, 37, 14, 34, 13, 31, 30, 15, 29, 25, 39, 21, 26, 19, 16, 20, 36, 27, 18],
    },
  ];
  ...
  return (
    <Card>
      ...
      <Divider />
      <CardContent>
        <Chart options={chartOptions} series={chartData} type='line' height={225} />
