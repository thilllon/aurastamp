      ...
      <Grid container alignItems='center'>
        <Grid item>
          <Box display='inline-flex' mr={2} position='relative'>
            ...
            >
              <Avatar sx={{ width: 134, height: 134 }} src={user.image} />
            </Box>
            <CircularProgress
              variant='determinate'
              sx={{ color: theme.colors.alpha.trueWhite[30] }}
              size={134}
              thickness={3}
              value={100}
            />
        ...
        <Grid item sx={{ flexGrow: 1 }}>
          <Box display='flex' alignItems='center' justifyContent='space-between'>
            <Box display='flex' alignItems='flex-start'>
              ...
              <Box>
                <TypographyPrimary
                  sx={{ fontSize: `${theme.typography.pxToRem(35)}` }}
                  variant='h1'
                >
                  {data.points}
                </TypographyPrimary>
                <TypographySecondary
                  variant='h3'
                  fontWeight='normal'
                  sx={{ pb: 2, fontSize: `${theme.typography.pxToRem(21)}` }}
                >
            ...
            >
              <Box sx={{ maxWidth: 130 }}>
                ...
                <Chart options={chartOptions} series={chartData1} type='area' height={50} />
              </Box>
              <Box sx={{ maxWidth: 130 }}>
                <Box
                  display='flex'
                ...
                <Chart options={chartOptions} series={chartData2} type='area' height={50} />
              </Box>
            </Stack>
          </Box>
        </Grid>
        ...
        <Grid xs={12} sm={6} lg={3} item>
          <Card sx={{ p: 3 }}>
            <Typography
              align='center'
              variant='h1'
              sx={{ fontSize: `${theme.typography.pxToRem(45)}` }}
            >
              {data.certificates}
            </Typography>
            <TypographyWrapper
              align='center'
              sx={{ fontSize: `${theme.typography.pxToRem(21)}` }}
              variant='h3'
              fontWeight='normal'
