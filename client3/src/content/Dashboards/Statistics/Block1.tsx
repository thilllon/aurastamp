  ...
  return (
    <Grid container spacing={4}>
      <Grid item xs={12} md={6}>
        <Card sx={{ p: 2.5, background: `${theme.colors.gradients.black1}` }}>
      ...
      <Grid item xs={12} md={6}>
        <Card sx={{ p: 2.5, background: `${theme.colors.gradients.blue4}` }}>
          <Box pb={2} display='flex' alignItems='center' justifyContent='space-between'>
            <Box>
              <Typography
                gutterBottom
          ...
          <Box display='flex' alignItems='center'>
            ...
            >
              <ArrowDownwardTwoToneIcon fontSize='small' sx={{ mr: 0.2 }} />
              <span>8.25%</span>
            </Typography>
            <Typography
              variant='subtitle2'
      ...
      <Grid item xs={12} md={6}>
        <Card sx={{ p: 2.5, background: `${theme.colors.gradients.green2}` }}>
          <Box pb={2} display='flex' alignItems='center' justifyContent='space-between'>
            <Box>
              <Typography
                gutterBottom
          ...
          <Box display='flex' alignItems='center'>
            ...
            >
              <CompareArrowsTwoToneIcon fontSize='small' sx={{ mr: 0.2 }} />
              <span>0.5%</span>
            </Typography>
            <Typography
              variant='subtitle2'
      ...
      <Grid item xs={12} md={6}>
        <Card sx={{ p: 2.5, background: `${theme.colors.gradients.blue2}` }}>
          <Box pb={2} display='flex' alignItems='center' justifyContent='space-between'>
            <Box>
              <Typography
                gutterBottom
