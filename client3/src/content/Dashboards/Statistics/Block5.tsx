    ...
    <Grid container spacing={4}>
      <Grid item xs={12} md={6}>
        ...
        >
          ...
          <Box ml={2} flexGrow={1}>
            <Chart options={chart1Options} series={chart1Data} type='line' height={80} />
          </Box>
        </Card>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          ...
          <Box ml={2} flexGrow={1}>
            <Chart options={chart2Options} series={chart2Data} type='line' height={80} />
          </Box>
        </Card>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          ...
          <Box ml={2} flexGrow={1}>
            <Chart options={chart3Options} series={chart3Data} type='line' height={80} />
          </Box>
        </Card>
      </Grid>
      <Grid item xs={12} md={6}>
        ...
        >
          ...
          <Box ml={2} flexGrow={1}>
            <Chart options={chart4Options} series={chart4Data} type='line' height={80} />
          </Box>
        </Card>
      </Grid>
    </Grid>
