  ...
  return (
    <Grid container spacing={4}>
      <Grid item xs={12} lg={4}>
        <Card sx={{ p: 3.5, textAlign: 'center', position: 'relative' }}>
          ...
          <Typography gutterBottom sx={{ pt: 3.5 }} variant='h2'>
            Hal9000
          </Typography>
          ...
          <Box sx={{ mx: 'auto', mt: 3, mb: 0.5, maxWidth: '340px' }}>
            <GaugeChart
              hideText
              nrOfLevels={6}
              colors={[
      ...
      <Grid item xs={12} lg={4}>
        ...
        >
          ...
          <Typography
            gutterBottom
            sx={{ color: `${theme.colors.alpha.trueWhite[100]}`, pt: 3.5 }}
            variant='h2'
          >
            Kitt2
          </Typography>
          ...
          <Box sx={{ mx: 'auto', mt: 3, mb: 0.5, maxWidth: '340px' }}>
            <GaugeChart
              hideText
              nrOfLevels={6}
              colors={[theme.colors.alpha.trueWhite[10], theme.colors.alpha.trueWhite[100]]}
