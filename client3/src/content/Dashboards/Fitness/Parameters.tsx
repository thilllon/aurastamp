    ...
    <Grid container spacing={4}>
      <Grid item sm={6} md={4} xs={12}>
        <Card sx={{ p: 2, overflow: 'visible' }}>
          ...
          <Chart options={chartOptions} series={chart1Data} type='line' height={100} />
        </Card>
      </Grid>
      <Grid item sm={6} md={4} xs={12}>
        <Card sx={{ p: 2, overflow: 'visible' }}>
          ...
          <Chart options={chartOptions} series={chart2Data} type='line' height={100} />
        </Card>
      </Grid>
      <Grid item md={4} xs={12}>
        <Card sx={{ p: 2, overflow: 'visible' }}>
          ...
          <Chart options={chartOptions} series={chart3Data} type='line' height={100} />
        </Card>
      </Grid>
    </Grid>
  );
