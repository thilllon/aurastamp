...
function Investments() {
  ...
  const [state, setState] = useState({ interest: true });
  ...
  return (
    <Card>
      ...
      <CardContent sx={{ p: 4 }}>
        ...
        <Box display='flex' alignItems='center' flexWrap='wrap' sx={{ pt: 5, pb: 4 }}>
        ...
        <Box sx={{ px: 1 }}>
          <Chart options={chartOptions} series={chartData} type='line' height={240} />
        </Box>
        <Divider sx={{ my: 3 }} />
        <Box sx={{ textAlign: 'center' }}>
