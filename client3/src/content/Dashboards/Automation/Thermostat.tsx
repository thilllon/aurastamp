...
const IconButtonIncrement = styled(IconButton)(
  ({ theme }) => `
      ...
      border-radius: 50px;
      box-shadow: 0px 1px 3px ${theme.colors.alpha.black[30]}, 0px 3px 8px 1px ${
...
const SwitchThumb = styled('span')(
  ...
  &:before {
    ...
    width: 100%;
    height: 100%;
    background: url('data:image/svg+xml;utf8,<svg xmlns="https://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 20 20"><path fill="${encodeURIComponent(
      '#fff'
  ...
  &.checked {
    ...
    &:before {
      background-image: url('data:image/svg+xml;utf8,<svg xmlns="https://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 20 20"><path fill="${encodeURIComponent(
        '#fff'
        ...
        <Grid item xs={12}>
          <Card>
            ...
            <Stack
              ...
              justifyContent='center'
              divider={
                <Divider sx={{ background: 'transparent' }} orientation='vertical' flexItem />
              }
            >
