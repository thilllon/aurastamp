...
function PowerConsumption() {
  ...
  const powerMonthly = [
    {
      name: 'Consumption',
      data: [34471, 37403, 10192, 48243, 37464, 32881, 43357, 40646, 36191, 25000, 10435, 4128],
    },
  ];
  ...
  return (
    <>
      ...
      <Card>
        ...
        {location === 'Daily' && (
          <Chart options={DailyPowerOptions} series={powerDaily} type='area' height={274} />
        )}
        {location === 'Weekly' && (
          <Chart options={WeeklyPowerOptions} series={powerWeekly} type='area' height={274} />
        )}
        {location === 'Monthly' && (
          <Chart options={MonthlyPowerOptions} series={powerMonthly} type='area' height={274} />
        )}
      </Card>
    </>
  );
