  ...
  return (
    <Card>
      <Box sx={{ position: 'relative' }}>
        ...
        />
        <CardActions>
          <LabelInfo sx={{ borderRadius: 50 }}>{t('Live transations')}</LabelInfo>
        </CardActions>
      </Box>
      <Box p={2}>
        <TableContainer>
            ...
            <TableBody>
              <TableRow hover>
                ...
                <TableCell align='right'>
                  ...
                  <Box mt={0.5} display='flex' justifyContent='flex-end' alignItems='flex-start'>
                ...
                <TableCell align='right'>
                  <Tooltip arrow placement='top' title={t('Cancel this transaction')}>
              ...
              <TableRow hover>
                <TableCell>
                  <Box display='flex' alignItems='center'>
                    <Avatar
                      sx={{
                        background: `${lighten(theme.colors.warning.main, 0.8)}`,
              ...
              <TableRow hover>
                <TableCell>
                  <Box display='flex' alignItems='center'>
                    <Avatar
                      sx={{
                        background: `${lighten(theme.colors.success.main, 0.8)}`,
