...
function Block3() {
  ...
  return (
    <Card>
      <Box px={2} py={1.8} display='flex' alignItems='center' justifyContent='space-between'>
        <Box>
          <Typography
            gutterBottom
      ...
      <Box px={5} pt={4}>
        <Typography
          component='h3'
          fontWeight='bold'
          sx={{ mb: 4, fontSize: `${theme.typography.pxToRem(45)}` }}
        >
          <CountUp
            start={0}
            end={487.3866234}
        ...
        <Grid container spacing={6}>
          <Grid item xs={12} md={4} sm={6}>
            ...
            <LinearProgressError sx={{ my: 1 }} variant='determinate' value={12} />
          ...
          <Grid item xs={12} md={4} sm={6}>
            ...
            <LinearProgressSuccess sx={{ my: 1 }} variant='determinate' value={46} />
            <Typography variant='body2' color='text.secondary'>
              {t('Outdoor')}
            </Typography>
          </Grid>
          <Grid item xs={12} md={4} sm={12}>
            ...
            <LinearProgressWarning sx={{ my: 1 }} variant='determinate' value={40} />
            <Typography variant='body2' color='text.secondary'>
              {t('Electronics')}
            </Typography>
          </Grid>
