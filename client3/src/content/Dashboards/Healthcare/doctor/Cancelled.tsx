...
function Cancelled() {
  ...
  return (
    <Card sx={{ px: 3, pb: 3 }}>
      <Chart options={chartOptions} series={chartData} type='line' height={244} />
      <Box display='flex' alignItems='center' sx={{ py: 2 }} justifyContent='center'>
      ...
      <Box display='flex' alignItems='center' justifyContent='center'>
        <Typography variant='h1' align='center' lineHeight={1} sx={{ mr: 1 }}>
          3
        </Typography>
