          ...
          <TableWrapper>
            ...
            <TableBody>
              <TableRow hover>
                ...
                <TableCell align='center'>
                  <div>
                    <Sparklines margin={6} data={[45, 56, 24, 56, 54, 38, 47, 38, 56, 24, 38]}>
                      <SparklinesLine
                        style={{
                      ...
                      />
                      <SparklinesReferenceLine
                        style={{ stroke: theme.colors.error.main }}
                        type='mean'
                      />
                    </Sparklines>
                  </div>
              ...
              <TableRow hover>
                ...
                <TableCell align='center'>
                  <div>
                    <Sparklines margin={6} data={[65, 34, 65, 77, 89, 54, 35, 87, 65, 94, 59, 54]}>
                      <SparklinesLine
                        style={{
                          stroke: theme.colors.primary.main,
                          strokeWidth: 3,
              ...
              <TableRow hover>
                ...
                <TableCell align='center'>
                  <div>
                    <Sparklines margin={6} data={[65, 45, 37, 97, 56, 37, 47, 24, 38]}>
                      <SparklinesLine
                        style={{
                          stroke: theme.colors.primary.main,
                          strokeWidth: 3,
                ...
                <TableCell align='right'>
                  <div>
                    <Typography
                      ...
                      color='text.secondary'
                    >
                      <Typography sx={{ pr: 0.5 }} component='span' variant='h4'>
