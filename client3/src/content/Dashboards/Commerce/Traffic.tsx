    ...
    <Card sx={{ height: '100%' }}>
      ...
      <Grid spacing={0} container>
        <Grid xs={12} md={5} item display='flex' alignItems='center'>
          <Grid container sx={{ p: 3 }} spacing={4}>
            <Grid xs={12} sm={6} md={12} item>
              <Typography variant='caption' noWrap sx={{ mb: 1.2 }} component='div'>
              ...
              >
                ...
                <ArrowTrendingUpWrapper sx={{ ml: 0.7 }} fontSize='small' />
              </Box>
            </Grid>
            <Divider sx={{ my: 3 }} />
            <Grid xs={12} sm={6} md={12} item>
              <Typography variant='caption' sx={{ mb: 1.2 }} noWrap component='div'>
              ...
              >
                ...
                <ArrowTrendingDownWrapper sx={{ ml: 0.7 }} fontSize='small' />
              </Box>
            </Grid>
          </Grid>
        </Grid>
        <Grid xs={12} md={7} item>
          <Box mr={2}>
            <Chart options={chartOptions} series={chartData} type='area' height={300} />
          </Box>
        </Grid>
      </Grid>
    </Card>
