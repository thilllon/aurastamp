...
function PageHeader() {
  ...
  const { acceptedFiles, isDragActive, isDragAccept, isDragReject, getRootProps, getInputProps } =
  ...
  const handleCreateProjectSuccess = () => {
    enqueueSnackbar(t('A new project has been created successfully'), { variant: 'success' });
  ...
  return (
    <>
      ...
      <Dialog fullWidth maxWidth='md' open={open} onClose={handleCreateProjectClose}>
        ...
        <Formik
          initialValues={{ title: '', submit: null }}
            ...
            <form onSubmit={handleSubmit}>
              <DialogContent dividers sx={{ p: 3 }}>
                <Grid container spacing={0}>
                  ...
                  <Grid sx={{ mb: `${theme.spacing(3)}` }} item xs={12} sm={8} md={9}>
                    <TextField
                  ...
                  <Grid sx={{ mb: `${theme.spacing(3)}` }} item xs={12} sm={8} md={9}>
                    <DatePicker
                      ...
                      renderInput={(params) => (
                        <TextField placeholder={t('Select due date...')} {...params} />
                      )}
                    />
                  </Grid>

                  <Grid item xs={12} sm={4} md={3} textAlign={{ sm: 'right' }}></Grid>
                  <Grid sx={{ mb: `${theme.spacing(3)}` }} item xs={12} sm={8} md={9}>
                    <Button
                      sx={{ mr: 2 }}
                      type='submit'
