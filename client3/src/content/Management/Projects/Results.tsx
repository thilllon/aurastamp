...
import { ChangeEvent, FC, forwardRef, MouseEvent, ReactElement, Ref, useState } from 'react';
...
const Results: FC<ResultsProps> = ({ projects = [] }) => {
  ...
  const handleDeleteCompleted = () => {
    ...
    enqueueSnackbar(t('The projects has been deleted successfully'), { variant: 'success' });
  };
                ...
                {paginatedProjects.map((project) => {
                  ...
                  return (
                    <Grid item xs={12} sm={6} md={4} key={project.name}>
                      <CardWrapper className={clsx({ 'Mui-selected': isProjectSelected })}>
