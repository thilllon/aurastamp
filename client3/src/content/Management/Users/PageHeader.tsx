...
function PageHeader() {
  ...
  const [publicProfile, setPublicProfile] = useState({ public: true });

  const handlePublicProfile = (event) => {
    setPublicProfile({ ...publicProfile, [event.target.name]: event.target.checked });
  };
  ...
  const handleCreateUserSuccess = () => {
    enqueueSnackbar(t('The user account was created successfully'), { variant: 'success' });
                    ...
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12} md={6}>
                        <Autocomplete
                          ...
                          renderInput={(params) => (
                            <TextField fullWidth {...params} label={t('User role')} />
                          )}
                        />
                      </Grid>
                    </Grid>
