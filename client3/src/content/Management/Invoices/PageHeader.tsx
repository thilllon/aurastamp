...
function PageHeader() {
  ...
  const handleCreateInvoiceSuccess = () => {
    enqueueSnackbar(t('A new invoice has been created successfully'), { variant: 'success' });
  ...
  return (
    <>
      ...
      <Dialog fullWidth maxWidth='md' open={open} onClose={handleCreateInvoiceClose}>
        ...
        <Formik
          initialValues={{ number: '', submit: null }}
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <DatePicker
                      ...
                      renderInput={(params) => (
                        <TextField fullWidth placeholder={t('Select date...')} {...params} />
                      )}
                    />
                  </Grid>
                  <Grid item xs={12} md={6}>
