...
const ProductBody: FC<ProductBodyProps> = ({ product }) => {
  ...
  const handleCart = () => {
    enqueueSnackbar(t('You added a product to cart'), { variant: 'success' });
  };
              ...
              <Box p={4} flex={1}>
                ...
                <Box pt={3} pb={1} sx={{ px: { xs: 0, md: 3 } }}>
                  <Grid container spacing={0}>
                    ...
                    <Grid sx={{ mb: `${theme.spacing(2)}` }} item xs={12} sm={8} md={6}>
                      <FormControl
                    ...
                    <Grid sx={{ mb: `${theme.spacing(2)}` }} item xs={12} sm={5} md={3}>
                      <FormControl fullWidth variant='outlined'>
                        <TextField type='number' size='small' InputLabelProps={{ shrink: true }} />
                      </FormControl>
                    </Grid>
                  </Grid>
                </Box>
