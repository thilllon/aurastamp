...
export const MailboxSingle: FC<MailboxSingleProps> = (props) => {
  ...
  const handleBack = tag && tag !== 'inbox' ? `/apps/mailbox?tag=${tag}` : '/apps/mailbox';
  ...
  return (
    <>
      <Box
        ...
        pb={3}
      >
        <Link href={handleBack}>
          <Tooltip arrow placement='top' title={t('Go back')}>
            <IconButton color='primary' sx={{ p: 1 }} component='a'>
      ...
      <Box px={3} display='flex' alignItems='flex-start' justifyContent='space-between'>
        <Box display='flex' alignItems='center'>
          {/* <Avatar sx={{ mr: 2 }} src={mailbox.from.avatar} /> */}
          <Box>
            <Typography variant='h4' gutterBottom>
              {/* {mailbox.from.email} */}
              <Typography component='span' variant='h5' color='text.secondary' fontWeight='normal'>
                {/* ({mailbox.from.name}) */}
              </Typography>
            </Typography>
        ...
        <Box ml={2} flexGrow={1}>
          <Card>
            <Box px={3} pt={2}>
              ...
              <Typography component='span' variant='h5' color='text.primary' fontWeight='bold'>
                {/* {mailbox.from.email} */}
                <Typography
                  component='span'
                  variant='h5'
