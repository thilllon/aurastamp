...
const DialogWrapper = styled(Dialog)(({ theme }) => ({
  ...
  '& .MuiDialog-paperScrollPaper': { minHeight: `calc(100vh - ${theme.header.height})` },
}));
          ...
          <form onSubmit={submitSearch}>
            <Box display='flex' alignItems='center'>
              <Box flexGrow={1} display='flex' alignItems='center'>
                <SearchTwoToneIcon sx={{ ml: 2, color: theme.colors.secondary.main }} />
                <SearchInputWrapper
                  value={searchValue}
                        ...
                        <Fragment key={result.title}>
                          <ListButton>
                            <Box display='flex' alignItems='flex-start'>
                              <RestoreTwoToneIcon sx={{ mr: 1 }} fontSize='small' />
                  ...
                  <Box pb={2} px={2}>
                    ...
                    <ListButton>
                      ...
                      <Box>
                        ...
                        <Tooltip placement='top' arrow title={t('Remove this search from history')}>
                    ...
                    <Typography sx={{ pt: 2, pb: 0.5 }} variant='h5'>
                      {t('Saved searches')}
                    </Typography>
                    <ListButton>
                      <Box display='flex' alignItems='center'>
                        <StarTwoToneIcon sx={{ mr: 1 }} fontSize='small' />
                    ...
                    <Box p={4}>
                      <Grid container spacing={3}>
                        <Grid item xs={12} sm={6}>
                          <Box display='flex' mb={1} fontSize={13} alignItems='center'>
                          ...
                          <List disablePadding>
                            <ListItem sx={{ pl: 3, py: 0.4 }} disableGutters>
