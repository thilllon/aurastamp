...
export const mpEvent = (event: string, props?: any) => {
  try {
    if (window.mixpanel) {
...
export const MixpanelScript = (
  { token, debug = false }: { token?: string; debug?: boolean } = { debug: false }
) => {
  ...
  return (
    <Script
      ...
      dangerouslySetInnerHTML={{
        ...
        mixpanel.init('${mixpanelToken}', {debug: ${debug}});`,
      }}
    />
  );
};
