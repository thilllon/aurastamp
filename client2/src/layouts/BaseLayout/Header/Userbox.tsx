...
import { AccountBoxTwoTone, ExpandMoreTwoTone, LockOpenTwoTone } from '@mui/icons-material';
import {
  Avatar,
  Box,
  Button,
    ...
    <>
      <UserBoxButton color='primary' variant='text' ref={ref} onClick={handleOpen}>
        ...
        <Box component='span' sx={{ display: { xs: 'none', sm: 'inline-block' } }}>
          <ExpandMoreTwoTone fontSize='small' sx={{ ml: 1 }} />
        </Box>
      </UserBoxButton>
      ...
      >
        ...
        <List sx={{ p: 1 }} component='nav'>
          <ListItem component={Link} href={'/profile/member'} button onClick={onClose}>
